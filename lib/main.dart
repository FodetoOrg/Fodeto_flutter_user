 ...
 /* ///Pass all uncaught "fatal" errors from the framework to Crashlytics
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyDRfqUOgtbOpvy7Jwa1yx32YJ74yUyuVew",
  authDomain: "fudeto-f84b4.firebaseapp.com",
  projectId: "fudeto-f84b4",
  storageBucket: "fudeto-f84b4.appspot.com",
  messagingSenderId: "785312306801",
  appId: "1:785312306801:web:5b3557dea20ccf762fadd0",
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyCxjCSPBEpzo_QKRaJ0jU3kx-H5KeU8upI",
        appId: "1:785312306801:android:d67b7d560ab4832d2fadd0",
        messagingSenderId: "785312306801",
        projectId: "fudeto-f84b4",
      ),
    );
